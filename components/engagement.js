    ...
    <div className="mt-20 relative overflow-hidden ">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="relative z-10    bg-black pb-8 sm:pb-16 md:pb-20 lg:w-full lg:max-w-2xl lg:pb-28 xl:pb-32 text-right float-right">
          ...
          <div className="mx-auto mt-10 max-w-7xl px-8 sm:mt-8 sm:px-6 md:mt-8 lg:mt-8 lg:px-8 xl:mt-12">
            <div className="sm:text-center lg:text-right">
              <h3 className="text-3xl font-bold tracking-tight text-amber-50 sm:text-3xl md:text-4xl">
                ...
                <div>
                  <span className="sm:mt-4 md:mt-6 lg:mt-8 xl:mt-10 block text-amber-300 xl:inline">
                    con expertos reales y OGs
                  </span>
                  <div>
                    <span className="sm:mt-4 md:mt-6 lg:mt-8 xl:mt-10 block text-amber-600 xl:inline">

  ...
  return (
    <div className="relative lg:mt-14">
      ...
      <div className="mt-14">
        ...
        <div className="w-full h-[30vh] flex justify-center overflow-hidden relative m-auto">
          {images.map((image, index) => {
            if (index === currentSlide) {
              return (
                <div
                  key={index}
                  className="bg-neutral-900 rounded-xl shadow-2xl shadow-slate-600 self-center p-10 "
                >
                  <div class="flex flex-row gap-12">
                    ...
                    <div class="basis-2/3 text-left">
                      ...
                      <div className="relative mt-4 text-gray-400">
                        <a
                          href={`https://www.twitter.com/${image.tw}`}
                          className="ml-3"
                        >
                          ...
                          <span className="ml-10 text-2xl">{image.tw}</span>
                        </a>
                      </div>
                    </div>
                  </div>
